...
abstract public class Mqtt implements MqttCallback
{
    ...
    */
    ...
    private final static String CORRELATION_ID = MESSAGE_SYSTEM_PROPERTY_IDENTIFIER_DECODED + ".cid";
    protected final static String MESSAGE_ID = MESSAGE_SYSTEM_PROPERTY_IDENTIFIER_DECODED + ".mid";
    private final static String TO = MESSAGE_SYSTEM_PROPERTY_IDENTIFIER_DECODED + ".to";
    private final static String USER_ID = MESSAGE_SYSTEM_PROPERTY_IDENTIFIER_DECODED + ".uid";
            ...
            if (propertyString.contains("="))
            {
                ...
                switch (key)
                {
                    ...
                    case MESSAGE_ID:
                        ...
                        break;
                    case IOTHUB_ACK:
                        message.setDeliveryAcknowledgement(value);
                        break;
                    case CORRELATION_ID:
